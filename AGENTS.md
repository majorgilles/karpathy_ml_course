...
- Include LaTeX formulas in standalone display blocks for central mathematical relationships. Do not rely on inline LaTeX inside prose or Markdown tables; use readable plain text or inline code there. Define every symbol in surrounding prose and prefer a readable progression from one-example loss to dataset-average loss.
